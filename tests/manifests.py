...
test_cases: List[TestCaseItem] = [
    ...
    TestCaseItem(
        ...
        shapes_path="shapes/cover/cover-lite/growth-form/shapes.ttl",
        valid_data_path="shapes/cover/cover-lite/growth-form/valid.ttl",
        invalid_data_path="shapes/cover/cover-lite/growth-form/invalid.ttl",
        expected_failures=7,
    ).astuple(),
    TestCaseItem(
        name="cover-lite-field-species-name",
        shapes_path="shapes/cover/cover-lite/field-species-name/shapes.ttl",
        valid_data_path="shapes/cover/cover-lite/field-species-name/valid.ttl",
        invalid_data_path="shapes/cover/cover-lite/field-species-name/invalid.ttl",
        expected_failures=6,
    ).astuple(),
    TestCaseItem(
        name="cover-lite-substrate-type",
        shapes_path="shapes/cover/cover-lite/substrate-type/shapes.ttl",
        valid_data_path="shapes/cover/cover-lite/substrate-type/valid.ttl",
        invalid_data_path="shapes/cover/cover-lite/substrate-type/invalid.ttl",
        expected_failures=7,
    ).astuple(),
    TestCaseItem(
        name="cover-lite-uppermost-height",
        shapes_path="shapes/cover/cover-lite/uppermost-height/shapes.ttl",
        valid_data_path="shapes/cover/cover-lite/uppermost-height/valid.ttl",
        invalid_data_path="shapes/cover/cover-lite/uppermost-height/invalid.ttl",
        expected_failures=8,
    ).astuple(),
    TestCaseItem(
        name="cover-lite-in-canopy-sky",
        shapes_path="shapes/cover/cover-lite/in-canopy-sky/shapes.ttl",
        valid_data_path="shapes/cover/cover-lite/in-canopy-sky/valid.ttl",
        invalid_data_path="shapes/cover/cover-lite/in-canopy-sky/invalid.ttl",
        expected_failures=6,
    ).astuple(),
]
